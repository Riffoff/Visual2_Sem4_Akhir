...
procedure TFormOrtu.kolomaktif;
begin
edit1.Enabled:= True;
edit2.Enabled:= True;
edit3.Enabled:= True;
...
procedure TFormOrtu.kolombersih;
begin
Edit1.Clear;
Edit2.Clear;
Edit3.Clear;
...
procedure TFormOrtu.b2Click(Sender: TObject);
begin
...
procedure TFormOrtu.b3Click(Sender: TObject);
begin
if (Edit1.Text= '')or (Edit2.Text ='') or (Edit3.Text= '')or (Edit4.Text ='') or (Edit5.Text= '')or (Edit6.Text ='') or (c1.Text= '')or (Edit7.Text= '')or (Edit8.Text= '')then
begin
...
procedure TFormOrtu.b4Click(Sender: TObject);
begin
...
procedure TFormOrtu.b5Click(Sender: TObject);
begin
posisiawal;
end;
...
procedure TFormOrtu.dg1CellClick(Column: TColumn);
begin
kolomaktif;
b1.Enabled:= true;
b2.Enabled:= False;
...
procedure TFormOrtu.b6Click(Sender: TObject);
begin
frxrprt1.ShowReport();
end;
