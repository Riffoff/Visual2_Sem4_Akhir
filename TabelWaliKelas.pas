...
procedure TFormWaliKelas.kolomaktif;
begin
edit1.Enabled:= True;
edit2.Enabled:= True;
c1.Enabled:= True;
...
procedure TFormWaliKelas.kolombersih;
begin
Edit1.Clear;
Edit2.Clear;
c1.text:= '';
...
procedure TFormWaliKelas.posisiawal;
begin
kolombersih;
...
procedure TFormWaliKelas.b2Click(Sender: TObject);
begin
...
procedure TFormWaliKelas.B3Click(Sender: TObject);
begin
if (Edit1.Text= '')or (Edit2.Text ='')or(c1.Text= '')or (Edit3.Text= '')or (Edit4.Text ='') or (Edit5.Text= '')or (Edit6.Text ='') or (Edit7.Text= '')then
begin
...
procedure TFormWaliKelas.b4Click(Sender: TObject);
begin
...
procedure TFormWaliKelas.b5Click(Sender: TObject);
begin
posisiawal;
end;

procedure TFormWaliKelas.b6Click(Sender: TObject);
begin
frxrprt1.ShowReport();
end;

procedure TFormWaliKelas.dg1CellClick(Column: TColumn);
begin
kolomaktif;
b1.Enabled:= true;
b2.Enabled:= False;
